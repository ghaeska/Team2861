...
public class ArmSubsystem extends SubsystemBase {
    ...
    public ArmSubsystem() {
        shoulderMotorRight = new CANSparkMax(16, MotorType.kBrushless);
        ...
        shoulderMotorLeft = new CANSparkMax(15, MotorType.kBrushless);
    ...
    private final static class Constants{     // arm setpoints
        private static final Rotation2d pickUp = Rotation2d.fromDegrees(-1);  // Find actual value - CL
        private static final Rotation2d speakerShoot = Rotation2d.fromDegrees(9.5);  // Find actual value - CL
        private static final Rotation2d ampShoot = Rotation2d.fromDegrees(85);  // Find actual value - CL
        private static final Rotation2d stow = Rotation2d.fromDegrees(20);  // Find actual value - CL
    }
